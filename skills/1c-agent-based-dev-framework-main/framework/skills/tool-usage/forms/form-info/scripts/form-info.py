...
def new_xml_parser(remove_blank_text=False):
    try:
        return etree.XMLParser(remove_blank_text=remove_blank_text)
    except TypeError:
...
def main():
    ...
    # --- Load XML ---
    parser_xml = new_xml_parser(remove_blank_text=False)
